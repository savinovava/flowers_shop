...
export function ListItemComponent(props: ListItemComponentProps) {
    ...
    return (
        <Card className={"list-item"} style={{ width: '18rem' }}>
            <Card.Img style={{height: 350}} variant="top" src={item.imageSrc} />
            <Card.Body>
                <Card.Title>
                ...
                <div className="add-to-cart"><Button onClick={() => addToCart(item)} variant="success">Добавить в корзину</Button></div>
            </Card.Body>
        </Card>
    );
}
